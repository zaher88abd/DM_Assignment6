...
print("F1 score - SVC:", f1_score(y_test, pipeline_SVC.predict(X_test), average='micro'))
print("Accuracy Score - SVC:", accuracy_score(y_test, pipeline_SVC.predict(X_test)))
